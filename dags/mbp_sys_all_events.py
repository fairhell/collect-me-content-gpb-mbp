...
from config.config_mbp import CUSTOMER, ORA_CONN_1
    ...
    ORA_CONN_1: {
        ...
        ANY: { 
            T_COLUMNS: {
                ...
                'EVENT_TIME' : { 'dt_event_time': TYPE_TIMESTAMP },
            },
            T_OPTIONS: {
...
"SELECT ID, TRX_CLIENT_ID, EVENT_TIME FROM SYS_ALL_EVENTS \
WHERE EVENT_TIME >= '__NEXT_START_VALUE__' \
