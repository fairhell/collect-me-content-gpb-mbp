...
db_data = {
    ...
    ORA_CONN_3: {
        ...
        ANY: { 
            T_COLUMNS: {
                'INCIDENT_ID' : { 'incident_id': TYPE_STR },
                'CREATE_TIME' : { 'dt_create_time': TYPE_TIMESTAMP },
                'WORK_STATE_TIME' : { 'dt_work_state_time': TYPE_TIMESTAMP },
...
"SELECT INCIDENT_ID, CREATE_TIME, WORK_STATE_TIME, ASSIGNMENT FROM GPBSMFLSTEPM1 \
