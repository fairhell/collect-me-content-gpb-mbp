...
db_data = {
    ...
    CONN_FROM: {
        ...
        ANY: { 
            T_COLUMNS: {
                'REQUEST_ID' : { 'request_id': TYPE_STR },
                'PROCESSING_STATE_TIME' : { 'processing_state_time': TYPE_TIMESTAMP },
                'VALIDATE_STATE_TIME' : { 'validate_state_time': TYPE_TIMESTAMP },
            },
            T_OPTIONS: {
...
to_char(GREATEST(COALESCE(PROCESSING_STATE_TIME,to_date('01-01-01','YY-MM-DD')), COALESCE(VALIDATE_STATE_TIME,to_date('01-01-01','YY-MM-DD'))), 'YYYY-MM-DD HH24:MI:SS') CONTROL_TIME \
FROM smadmin.GPBSMFLSMSM1 \
WHERE GREATEST(COALESCE(PROCESSING_STATE_TIME,to_date('01-01-01','YY-MM-DD')), COALESCE(VALIDATE_STATE_TIME,to_date('01-01-01','YY-MM-DD'))) >= to_date('__NEXT_START_VALUE__', 'YYYY-MM-DD HH24:MI:SS') \
...
with DAG(
    ...
    params = {
        ...
        T_TABLE_VALUE: 't_mbp_gpbsmflsmsm1',
